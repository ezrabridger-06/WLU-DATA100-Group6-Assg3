---
title: "Assignment 3 - Exploring Disparate Data: Part 1"
...
# While you're here, make sure your group number is filled in above.
...
ice_extent_yearly <- ice_extent_daily |>
  ...
  summarise(min = min(ice_extent), max = max(ice_extent), .groups = "drop") |>
